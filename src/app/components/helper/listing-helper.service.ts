...
import listingcategory from '../data/listings/category.json';
import listingblock from '../data/listings/listing.json';
import selectdata from '../data/listings/selectdata.json';
