...
export class OrdersComponent implements OnInit {
    ...
    loadVenueOrderList() {
        var query = "?filterByDisable=false&filterByStatus=true&filterByOrderType=book_now&filterByCustomerId=" + this.userId;
                ...
                if (data.data != undefined) {
                    ...
                    if (this.venueOrderList.length > 0) {
                        this.venueOrderList.forEach(element => {
                            ...
                            if (element['foodType'].length > 0) {
                                if (element['foodType'][0] == 'veg_food') {
                                    element['foodTypeName'] = "Veg Food";
                                }
                                if (element['foodType'][0] == 'non_veg') {
                                    element['foodTypeName'] = "Non Veg Food";
                                }
                                if (element['foodType'][0] == 'mixFood') {
                                    element['foodTypeName'] = "Mix Food";
                                }
                                if (element['foodType'][0] == 'jainFood') {
                                    element['foodTypeName'] = "Jain Food";
                                }
                            }
                        })
                    }
