...
export class CategoryComponent implements OnInit {
    ...
    loadCategory(event: LazyLoadEvent){
        ...
        //var query="?filterByDisable=false&filterByLevel=1";
        var query="?filterByDisable=false&getOnlyParent=true";
        var pagenumber;
        var params="";
        var rows;
    ...
    deleteCategory(category) {
        this.confirmationService.confirm({
            ...
            accept: () => {
                ...
                var categoryData = '{"disable":'+disableStatus+'}';
    ...
    addNewCategory(){
        this.router.navigate(['/manage/category/category/add']);
    }
    
    editCategory(id) {
        this.router.navigate(['/manage/category/category/'+id]);
    }
    viewCategory(id) {
        this.router.navigate(['/manage/category/category/view/'+id]);
    }
